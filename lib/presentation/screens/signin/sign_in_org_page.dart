...
@RoutePage()
class SignInOrgPage extends StatelessWidget implements AutoRouteWrapper {
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            const VGap(gap: 20),
            TextExLarge('Welcome Back', align: TextAlign.center),
            TextRegular(" Safe Zone Organizations", bold: true),
            const VGap(gap: 50),
            SizedBox(
              width: 600,
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      TextLarge('Sign In To Your Organization Account'),
                      const VGap(),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const VGap(gap: 50),
                      OtpInputRow(
                        onOtpChanged: (otpList) => otp.value = otpList,
                      ),
                      const VGap(gap: 50),
                      FilledButton(
                        onPressed:
