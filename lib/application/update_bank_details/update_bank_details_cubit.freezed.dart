...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateBankDetailsState);
}
...
/// @nodoc
class $UpdateBankDetailsStateCopyWith<$Res>  {
$UpdateBankDetailsStateCopyWith(UpdateBankDetailsState _, $Res Function(UpdateBankDetailsState) __);
}


/// Adds pattern-matching-related methods to [UpdateBankDetailsState].
extension UpdateBankDetailsStatePatterns on UpdateBankDetailsState {
...
class _Initial implements UpdateBankDetailsState {
  const _Initial();
...
class _Loading implements UpdateBankDetailsState {
  const _Loading();
...
class _Succeed implements UpdateBankDetailsState {
  const _Succeed();
...
class _Failed implements UpdateBankDetailsState {
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $UpdateBankDetailsStateCopyWith<$Res> {
