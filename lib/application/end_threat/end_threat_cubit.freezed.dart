...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EndThreatState);
}
...
/// @nodoc
class $EndThreatStateCopyWith<$Res>  {
$EndThreatStateCopyWith(EndThreatState _, $Res Function(EndThreatState) __);
}


/// Adds pattern-matching-related methods to [EndThreatState].
extension EndThreatStatePatterns on EndThreatState {
...
class _Initial implements EndThreatState {
  const _Initial();
...
class _Loading implements EndThreatState {
  const _Loading();
...
class _Succeed implements EndThreatState {
  const _Succeed();
...
class _Failed implements EndThreatState {
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $EndThreatStateCopyWith<$Res> {
