...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WatchUserThreatsState);
}
...
/// @nodoc
class $WatchUserThreatsStateCopyWith<$Res>  {
$WatchUserThreatsStateCopyWith(WatchUserThreatsState _, $Res Function(WatchUserThreatsState) __);
}


/// Adds pattern-matching-related methods to [WatchUserThreatsState].
extension WatchUserThreatsStatePatterns on WatchUserThreatsState {
...
class _Loading implements WatchUserThreatsState {
  const _Loading();
...
@override
String toString() {
  return 'WatchUserThreatsState.loading()';
}
...
class _Watching implements WatchUserThreatsState {
...
/// Create a copy of WatchUserThreatsState
...
@override
String toString() {
  return 'WatchUserThreatsState.watching(threats: $threats)';
}
...
/// @nodoc
abstract mixin class _$WatchingCopyWith<$Res> implements $WatchUserThreatsStateCopyWith<$Res> {
...
class _Failed implements WatchUserThreatsState {
...
@override
String toString() {
  return 'WatchUserThreatsState.failed(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $WatchUserThreatsStateCopyWith<$Res> {
