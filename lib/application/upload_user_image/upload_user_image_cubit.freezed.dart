...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UploadUserImageState);
}
...
/// @nodoc
class $UploadUserImageStateCopyWith<$Res>  {
$UploadUserImageStateCopyWith(UploadUserImageState _, $Res Function(UploadUserImageState) __);
}


/// Adds pattern-matching-related methods to [UploadUserImageState].
extension UploadUserImageStatePatterns on UploadUserImageState {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Initial value)?  initial,TResult Function( _Uploading value)?  uploading,TResult Function( _Uploaded value)?  uploaded,TResult Function( _Failed value)?  failed,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Initial value)  initial,required TResult Function( _Uploading value)  uploading,required TResult Function( _Uploaded value)  uploaded,required TResult Function( _Failed value)  failed,}){
final _that = this;
switch (_that) {
case _Initial():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Initial value)?  initial,TResult? Function( _Uploading value)?  uploading,TResult? Function( _Uploaded value)?  uploaded,TResult? Function( _Failed value)?  failed,}){
final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial(_that);case _Uploading() when uploading != null:
...
return uploading();case _Uploaded() when uploaded != null:
...
return uploading();case _Uploaded():
...
class _Initial implements UploadUserImageState {
  const _Initial();
...
@override
String toString() {
  return 'UploadUserImageState.initial()';
}
...
class _Uploading implements UploadUserImageState {
  const _Uploading();
...
@override
String toString() {
  return 'UploadUserImageState.uploading()';
}
...
class _Uploaded implements UploadUserImageState {
  const _Uploaded(this.downloadUrl);
  

 final  String downloadUrl;

/// Create a copy of UploadUserImageState
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Uploaded&&(identical(other.downloadUrl, downloadUrl) || other.downloadUrl == downloadUrl));
}
...
@override
String toString() {
  return 'UploadUserImageState.uploaded(downloadUrl: $downloadUrl)';
}
...
/// @nodoc
abstract mixin class _$UploadedCopyWith<$Res> implements $UploadUserImageStateCopyWith<$Res> {
...
class _Failed implements UploadUserImageState {
...
@override
String toString() {
  return 'UploadUserImageState.failed(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $UploadUserImageStateCopyWith<$Res> {
