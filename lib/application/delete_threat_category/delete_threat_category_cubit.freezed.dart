...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteThreatCategoryState);
}
...
@override
String toString() {
  return 'DeleteThreatCategoryState()';
}
...
/// @nodoc
class $DeleteThreatCategoryStateCopyWith<$Res>  {
$DeleteThreatCategoryStateCopyWith(DeleteThreatCategoryState _, $Res Function(DeleteThreatCategoryState) __);
}


/// Adds pattern-matching-related methods to [DeleteThreatCategoryState].
extension DeleteThreatCategoryStatePatterns on DeleteThreatCategoryState {
...
class _Initial implements DeleteThreatCategoryState {
  const _Initial();
...
class _Loading implements DeleteThreatCategoryState {
  const _Loading();
...
class _Succeed implements DeleteThreatCategoryState {
  const _Succeed();
...
class _Failed implements DeleteThreatCategoryState {
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $DeleteThreatCategoryStateCopyWith<$Res> {
