...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteServiceState);
}
...
/// @nodoc
class $DeleteServiceStateCopyWith<$Res>  {
$DeleteServiceStateCopyWith(DeleteServiceState _, $Res Function(DeleteServiceState) __);
}


/// Adds pattern-matching-related methods to [DeleteServiceState].
extension DeleteServiceStatePatterns on DeleteServiceState {
...
class _Initial implements DeleteServiceState {
  const _Initial();
...
class _Loading implements DeleteServiceState {
  const _Loading();
...
class _Succeed implements DeleteServiceState {
  const _Succeed();
...
class _Failed implements DeleteServiceState {
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $DeleteServiceStateCopyWith<$Res> {
