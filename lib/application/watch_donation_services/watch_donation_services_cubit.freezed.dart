...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WatchDonationServicesState);
}
...
@override
String toString() {
  return 'WatchDonationServicesState()';
}
...
/// @nodoc
class $WatchDonationServicesStateCopyWith<$Res>  {
$WatchDonationServicesStateCopyWith(WatchDonationServicesState _, $Res Function(WatchDonationServicesState) __);
}


/// Adds pattern-matching-related methods to [WatchDonationServicesState].
extension WatchDonationServicesStatePatterns on WatchDonationServicesState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( List<DonationService> services)?  watching,TResult Function( String message)?  failed,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Watching() when watching != null:
return watching(_that.services);case _Failed() when failed != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( List<DonationService> services)  watching,required TResult Function( String message)  failed,}) {final _that = this;
switch (_that) {
case _Loading():
return loading();case _Watching():
return watching(_that.services);case _Failed():
return failed(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( List<DonationService> services)?  watching,TResult? Function( String message)?  failed,}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Watching() when watching != null:
return watching(_that.services);case _Failed() when failed != null:
...
class _Loading implements WatchDonationServicesState {
  const _Loading();
...
class _Watching implements WatchDonationServicesState {
  const _Watching(final  List<DonationService> services): _services = services;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Watching&&const DeepCollectionEquality().equals(other._services, _services));
}
...
/// @nodoc
abstract mixin class _$WatchingCopyWith<$Res> implements $WatchDonationServicesStateCopyWith<$Res> {
...
class _Failed implements WatchDonationServicesState {
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $WatchDonationServicesStateCopyWith<$Res> {
