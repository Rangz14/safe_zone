...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UploadOrgImagesState);
}
...
/// @nodoc
class $UploadOrgImagesStateCopyWith<$Res>  {
$UploadOrgImagesStateCopyWith(UploadOrgImagesState _, $Res Function(UploadOrgImagesState) __);
}


/// Adds pattern-matching-related methods to [UploadOrgImagesState].
extension UploadOrgImagesStatePatterns on UploadOrgImagesState {
...
class _Initial implements UploadOrgImagesState {
  const _Initial();
...
@override
String toString() {
  return 'UploadOrgImagesState.initial()';
}
...
class _Uploading implements UploadOrgImagesState {
  const _Uploading();
...
@override
String toString() {
  return 'UploadOrgImagesState.uploading()';
}
...
class _Uploaded implements UploadOrgImagesState {
  const _Uploaded(this.downloadUrl);
  

 final  String downloadUrl;

/// Create a copy of UploadOrgImagesState
...
@override
String toString() {
  return 'UploadOrgImagesState.uploaded(downloadUrl: $downloadUrl)';
}
...
/// @nodoc
abstract mixin class _$UploadedCopyWith<$Res> implements $UploadOrgImagesStateCopyWith<$Res> {
...
class _Failed implements UploadOrgImagesState {
...
@override
String toString() {
  return 'UploadOrgImagesState.failed(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $UploadOrgImagesStateCopyWith<$Res> {
