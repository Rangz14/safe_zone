...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NewThreatCategoryState);
}
...
/// @nodoc
class $NewThreatCategoryStateCopyWith<$Res>  {
$NewThreatCategoryStateCopyWith(NewThreatCategoryState _, $Res Function(NewThreatCategoryState) __);
}


/// Adds pattern-matching-related methods to [NewThreatCategoryState].
extension NewThreatCategoryStatePatterns on NewThreatCategoryState {
...
class _Initial implements NewThreatCategoryState {
  const _Initial();
...
class _Loading implements NewThreatCategoryState {
  const _Loading();
...
class _Succeed implements NewThreatCategoryState {
  const _Succeed();
...
class _Failed implements NewThreatCategoryState {
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $NewThreatCategoryStateCopyWith<$Res> {
