...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NewDonationServiceState);
}
...
@override
String toString() {
  return 'NewDonationServiceState()';
}
...
/// @nodoc
class $NewDonationServiceStateCopyWith<$Res>  {
$NewDonationServiceStateCopyWith(NewDonationServiceState _, $Res Function(NewDonationServiceState) __);
}


/// Adds pattern-matching-related methods to [NewDonationServiceState].
extension NewDonationServiceStatePatterns on NewDonationServiceState {
...
class _Initial implements NewDonationServiceState {
  const _Initial();
...
class _Loading implements NewDonationServiceState {
  const _Loading();
...
class _Succeed implements NewDonationServiceState {
  const _Succeed();
...
class _Failed implements NewDonationServiceState {
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $NewDonationServiceStateCopyWith<$Res> {
