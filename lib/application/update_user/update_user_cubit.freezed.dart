...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateUserState);
}
...
/// @nodoc
class $UpdateUserStateCopyWith<$Res>  {
$UpdateUserStateCopyWith(UpdateUserState _, $Res Function(UpdateUserState) __);
}
...
class _Initial implements UpdateUserState {
  const _Initial();
...
class _Loading implements UpdateUserState {
  const _Loading();
...
class _Succeed implements UpdateUserState {
  const _Succeed();
...
@override
String toString() {
  return 'UpdateUserState.succeed()';
}
...
class _Failed implements UpdateUserState {
...
@override
String toString() {
  return 'UpdateUserState.failed(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $UpdateUserStateCopyWith<$Res> {
