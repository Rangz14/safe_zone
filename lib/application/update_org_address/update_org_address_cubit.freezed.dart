...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateOrgAddressState);
}
...
/// @nodoc
class $UpdateOrgAddressStateCopyWith<$Res>  {
$UpdateOrgAddressStateCopyWith(UpdateOrgAddressState _, $Res Function(UpdateOrgAddressState) __);
}


/// Adds pattern-matching-related methods to [UpdateOrgAddressState].
extension UpdateOrgAddressStatePatterns on UpdateOrgAddressState {
...
class _Initial implements UpdateOrgAddressState {
  const _Initial();
...
class _Loading implements UpdateOrgAddressState {
  const _Loading();
...
class _Succeed implements UpdateOrgAddressState {
  const _Succeed();
...
class _Failed implements UpdateOrgAddressState {
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $UpdateOrgAddressStateCopyWith<$Res> {
