...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateUserAddressState);
}
...
/// @nodoc
class $UpdateUserAddressStateCopyWith<$Res>  {
$UpdateUserAddressStateCopyWith(UpdateUserAddressState _, $Res Function(UpdateUserAddressState) __);
}


/// Adds pattern-matching-related methods to [UpdateUserAddressState].
extension UpdateUserAddressStatePatterns on UpdateUserAddressState {
...
class _Initial implements UpdateUserAddressState {
  const _Initial();
...
class _Loading implements UpdateUserAddressState {
  const _Loading();
...
class _Loaded implements UpdateUserAddressState {
  const _Loaded();
...
class _Failed implements UpdateUserAddressState {
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $UpdateUserAddressStateCopyWith<$Res> {
