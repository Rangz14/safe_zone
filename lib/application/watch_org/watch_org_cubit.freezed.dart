...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WatchOrgState);
}
...
/// @nodoc
class $WatchOrgStateCopyWith<$Res>  {
$WatchOrgStateCopyWith(WatchOrgState _, $Res Function(WatchOrgState) __);
}


/// Adds pattern-matching-related methods to [WatchOrgState].
extension WatchOrgStatePatterns on WatchOrgState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( Organization organization)?  watching,TResult Function( String message)?  failed,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Watching() when watching != null:
return watching(_that.organization);case _Failed() when failed != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( Organization organization)  watching,required TResult Function( String message)  failed,}) {final _that = this;
switch (_that) {
case _Loading():
return loading();case _Watching():
return watching(_that.organization);case _Failed():
return failed(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( Organization organization)?  watching,TResult? Function( String message)?  failed,}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Watching() when watching != null:
return watching(_that.organization);case _Failed() when failed != null:
...
class _Loading implements WatchOrgState {
  const _Loading();
...
class _Watching implements WatchOrgState {
  const _Watching(this.organization);
  

 final  Organization organization;

/// Create a copy of WatchOrgState
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Watching&&(identical(other.organization, organization) || other.organization == organization));
}
...
@override
String toString() {
  return 'WatchOrgState.watching(organization: $organization)';
}
...
/// @nodoc
abstract mixin class _$WatchingCopyWith<$Res> implements $WatchOrgStateCopyWith<$Res> {
...
class _Failed implements WatchOrgState {
...
@override
String toString() {
  return 'WatchOrgState.failed(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailedCopyWith<$Res> implements $WatchOrgStateCopyWith<$Res> {
